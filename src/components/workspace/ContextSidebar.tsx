...
export default function ContextSidebar({ project, projectId, hasGeneratedContent }: Props) {
  ...
  return (
    <aside className="w-72 border-l border-border/50 bg-card/30 shrink-0 flex flex-col overflow-hidden hidden lg:flex">
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <Tabs defaultValue="progress" className="w-full">
          ...
          <TabsContent value="progress" className="p-4 pt-0">
          ...
          <TabsContent value="context" className="p-4 pt-0">
            <section>
