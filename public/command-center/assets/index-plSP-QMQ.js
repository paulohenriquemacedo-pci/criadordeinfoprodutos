...
`);ee=M.pop();for(const F of M){const N=F.trim();if(N.startsWith("data: ")){const H=N.substring(6);if(H==="[DONE]"){p();return}try{const K=((r=(m=(x=JSON.parse(H).choices)==null?void 0:x[0])==null?void 0:m.delta)==null?void 0:r.content)||"";K&&s(K)}catch{}}}}}catch(c){console.error("[STREAM ERROR]",c),u(c)}},async generatePostImage(t,e,n,i){return await le("/generate-post-image",{prompt:t,style:e,width:n,height:i})},async searchStockImages(t,e=12,n="portrait"){return await le("/search-stock-images",{query:t,perPage:e,orientation:n})},async generatePostCaption(t,e,n,i,o,a="profissional e engajante",s="Instagram"){return await le("/generate-post-caption",{headline:t,subheadline:e,body:n,niche:i,targetAudience:o,tone:a,platform:s})},async localGetHealth(){return await _("/health")},async localGetSettings(){return await _("/settings")},async localUpdateSettings(t){return await _("/settings",{method:"POST",body:JSON.stringify(t)})},async localGetKbStats(){return await _("/kb/stats")},async localGetKbFiles(){return await _("/kb/files")},async localGetAvatars(){return await _("/kb/avatars")},async localGetMarketData(){return await _("/kb/market-data")},async localGetModules(){return await _("/kb/modules")},async localForceSync(){return await _("/kb/sync",{method:"POST"})},async localGetGenerations(t=50){return await _(`/generations?limit=${t}`)},async localRateGeneration(t,e){return await _("/generations/rate",{method:"POST",body:JSON.stringify({generation_id:t,rating:e})})},async localGenerateMetaAds(t,e,n,i,o,a){return await _("/generate/meta-ads",{method:"POST",body:JSON.stringify({avatar_id:t||null,market_data_id:e||null,custom_prompt:n||null,provider:i||null,model:o||null,funnel_stage:a||"TOPO"})})},async localGenerateInstagram(t,e,n,i,o,a){return await _("/generate/instagram",{method:"POST",body:JSON.stringify({module_id:t,custom_prompt:e||null,provider:n||null,model:i||null,funnel_stage:o||"TOPO",post_type:a||"carrossel"})})},async localGenerateBlog(t,e,n,i,o,a){return await _("/generate/blog-post",{method:"POST",body:JSON.stringify({keyword:t,custom_prompt:e||null,provider:n||null,model:i||null,funnel_stage:o||"TOPO",output_format:a||"markdown"})})},async localGenerateProduct(t,e,n,i,o){return await _("/generate/product",{method:"POST",body:JSON.stringify({module_id:t,custom_prompt:e||null,provider:n||null,model:i||null,funnel_stage:o||"TOPO"})})},async localGenerateThemes(t,e,n,i,o,a,s,p=null){return await _("/generate/themes",{method:"POST",body:JSON.stringify({funnel_stage:t,priority_icp:e,round_objective:n,qty_per_stage:parseInt(i)||5,target_channel:o,provider:a||null,model:s||null,custom_subject:p})})},async localGenerateCampaign(t,e,n,i,o){return await _("/generate/campaign",{method:"POST",body:JSON.stringify({theme:t,provider:e||null,model:n||null,output_format:i||"markdown",insta_post_type:o||"carrossel"})})},async localAdaptContent(t,e,n,i,o,a,s){return await _("/generate/adapt",{method:"POST",body:JSON.stringify({content:t,source_format:e,target_format:n,provider:i||null,model:o||null,output_format:a||"markdown",custom_rules:s||null})})},async localPerplexitySearch(t,e=null,n=null){return await _("/perplexity/search",{method:"POST",body:JSON.stringify({query:t,system_prompt:e,model:n})})},async restGet(t){return await J(t)},async restPost(t,e){return await se(t,e)},async restPatch(t,e){return await ge(t,e)},async driveStatus(){return await _("/drive/status")},async driveSync(){return await _("/drive/sync",{method:"POST"})},async driveSyncWait(){return await _("/drive/sync-wait",{method:"POST"})},async driveListFiles(){return await _("/drive/files")}};async function J(t){const e=`${Z}/rest/v1${t}`,n=await fetch(e,{headers:{apikey:Q,Authorization:`Bearer ${ae()}`}});if(!n.ok)throw new Error(`Falha Supabase GET ${t}: ${n.statusText}`);return await n.json()}async function se(t,e){const n=`${Z}/rest/v1${t}`,i=await fetch(n,{method:"POST",headers:{apikey:Q,Authorization:`Bearer ${ae()}`,"Content-Type":"application/json",Prefer:"return=representation"},body:JSON.stringify(e)});if(!i.ok){const o=await i.text();throw new Error(`Falha Supabase POST ${t}: ${o}`)}return await i.json()}async function ge(t,e){const n=`${Z}/rest/v1${t}`,i=await fetch(n,{method:"PATCH",headers:{apikey:Q,Authorization:`Bearer ${ae()}`,"Content-Type":"application/json"},body:JSON.stringify(e)});if(!i.ok){const o=await i.text();throw new Error(`Falha Supabase PATCH ${t}: ${o}`)}return i.status===204?{success:!0}:await i.json()}async function le(t,e){const n=`${Z}/functions/v1${t}`,i=await fetch(n,{method:"POST",headers:{apikey:Q,Authorization:`Bearer ${ae()}`,"Content-Type":"application/json"},body:JSON.stringify(e)});if(!i.ok){const o=await i.text();throw new Error(`Falha Edge Function ${t}: ${o}`)}return await i.json()}const Ce="https://command-center-backend-veq6.onrender.com/api";async function _(t,e={}){const n=`${Ce}${t}`,i={"Content-Type":"application/json",...e.headers},o={...e,headers:i};try{const a=await fetch(n,o);if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.detail||`Erro na API Local: ${a.statusText}`)}return await a.json()}catch(a){throw console.error(`Erro no endpoint local ${t}:`,a),a}}const l={currentPage:"dashboard",activeProjectId:localStorage.getItem("activeProjectId")||null,activeProject:null,projectsList:[],kbFiles:[],avatars:[],marketData:[],modules:[],activeGenerationText:"",coherenceReport:null,localHealth:!1,localSettings:{groq_api_key:"",openrouter_api_key:"",perplexity_api_key:"",gemini_api_key:"",unsplash_access_key:"",default_provider:"groq",workspace_path:"d:/0 - SISTEMA ACADEMIA"},localKbStats:{total_files:0,total_words:0},localKbFiles:[],localAvatars:[],localMarketData:[],localModules:[],localActiveProvider:"groq",localActiveModel:"llama-3.3-70b-versatile",localActiveGeneration:null,localActiveCampaignPieces:{meta_ads:"",instagram:"",blog:""}};document.addEventListener("DOMContentLoaded",async()=>{$e(),await ve(),oe(l.currentPage),oe(l.currentPage)});function $e(){const t=document.querySelectorAll(".nav-item");t.forEach(e=>{e.addEventListener("click",n=>{n.preventDefault();const i=e.getAttribute("data-page");t.forEach(o=>o.classList.remove("active")),e.classList.add("active"),l.currentPage=i,oe(i)})})}async function ve(){try{if(l.avatars=await k.getAvatars(),l.marketData=await k.getMarketData(),l.modules=await k.getModules(),l.projectsList=await k.getProjects(),l.activeProjectId){const t=l.projectsList.find(e=>e.id===l.activeProjectId);t?(l.activeProject=t,l.kbFiles=await k.getProjectFiles(l.activeProjectId)):(l.activeProjectId=null,l.activeProject=null)}}catch(t){console.error("Erro ao carregar dados Supabase:",t)}try{l.localSettings=await k.localGetSettings(),l.localHealth=!0,l.localActiveProvider=l.localSettings.default_provider||"groq",l.localActiveProvider==="groq"?l.localActiveModel="llama-3.3-70b-versatile":l.localActiveProvider==="gemini"?l.localActiveModel="gemini-2.5-flash":l.localActiveProvider==="openrouter"?l.localActiveModel="anthropic/claude-sonnet-4.5":l.localActiveProvider==="perplexity"&&(l.localActiveModel="sonar-reasoning-pro"),l.localAvatars=await k.localGetAvatars(),l.localMarketData=await k.localGetMarketData(),l.localModules=await k.localGetModules(),l.localKbStats=await k.localGetKbStats(),l.localKbFiles=await k.localGetKbFiles(),console.log("[OK] Dados locais carregados com sucesso.")}catch(t){console.warn("[WARN] Cérebro local offline ou inacessível:",t),l.localHealth=!1}Te(),we()}function Te(){const t=document.getElementById("active-model-display"),e=document.getElementById("header-sync-btn");t&&(t.innerHTML=`
    ...
    `,document.body.appendChild(t);const e=()=>t.remove();document.getElementById("btn-close-project-selector").onclick=e,t.querySelectorAll(".proj-select-btn").forEach(n=>{n.onclick=async()=>{const i=n.getAttribute("data-id");l.activeProjectId=i,localStorage.setItem("activeProjectId",i),e(),await ve(),b("Projeto alterado!","success"),oe(l.currentPage)}})}function Be(t){let e=[...l.kbFiles];const n=[...new Set(l.kbFiles.map(m=>m.folder))].sort(),i=m=>{const r=document.getElementById("kb-table-body");if(r){if(m.length===0){r.innerHTML='<tr><td colspan="5" style="text-align: center; color: var(--text-muted); padding: 40px 0;">Nenhum arquivo de apoio indexado na nuvem para este projeto.</td></tr>';return}r.innerHTML=m.map(c=>{let g="file",h="";const y=c.filename.split(".").pop().toLowerCase();y==="docx"?(g="file-word",h="docx"):y==="pdf"?(g="file-text",h="pdf"):y==="md"&&(g="code",h="md");const P=new Intl.NumberFormat("pt-BR").format(c.word_count||0);return`
                <tr>
                    <td>
            ...
            `}).join(""),r.querySelectorAll(".btn-view-preview").forEach(c=>{c.addEventListener("click",()=>{const g=c.getAttribute("data-id"),h=l.kbFiles.find(y=>y.id===g);h&&Le(h)})}),r.querySelectorAll(".btn-delete-file").forEach(c=>{c.addEventListener("click",async()=>{const g=c.getAttribute("data-id"),h=c.getAttribute("data-url");if(confirm("Tem certeza de que deseja deletar este arquivo da Base de Conhecimento?")){b("Excluindo arquivo...","info");try{await k.deleteReferenceFile(g,h),b("Arquivo excluído com sucesso!","success"),l.kbFiles=await k.getProjectFiles(l.activeProjectId),i(l.kbFiles)}catch(y){b(`Erro ao excluir arquivo: ${y.message}`,"error")}}})}),lucide.createIcons()}};t.innerHTML=`
        <div class="page-title-section">
        ...
        <div class="kb-filters-bar">
            <select id="folder-filter" class="filter-select">
                ...
                ${n.map(m=>`<option value="${m}">${m}</option>`).join("")}
            </select>
    ...
    `,i(e);const o=document.getElementById("drag-drop-zone"),a=document.getElementById("kb-file-input");o.onclick=()=>a.click(),o.ondragover=m=>{m.preventDefault(),o.style.borderColor="var(--accent-cyan)"},o.ondragleave=()=>{o.style.borderColor="rgba(124, 58, 237, 0.4)"},o.ondrop=async m=>{m.preventDefault(),o.style.borderColor="rgba(124, 58, 237, 0.4)";const r=m.dataTransfer.files;r.length>0&&s(r[0])},a.onchange=async()=>{a.files.length>0&&s(a.files[0])};const s=async m=>{if(!m.name.endsWith(".pdf")){b("Apenas arquivos PDF são aceitos no momento!","error");return}b(`Subindo e indexando PDF: ${m.name}...`,"info");try{await k.uploadReferenceFile(l.activeProjectId,m,"02 - MATERIAIS_BÔNUS_DE_APOIO"),b("PDF carregado! A IA está extraindo o texto em segundo plano...","success"),l.kbFiles=await k.getProjectFiles(l.activeProjectId),i(l.kbFiles)}catch(r){b(`Falha ao subir arquivo: ${r.message}`,"error")}},p=document.getElementById("folder-filter"),u=document.getElementById("kb-table-search"),x=()=>{const m=p.value,r=u.value.toLowerCase();let c=[...l.kbFiles];m!=="all"&&(c=c.filter(g=>g.folder===m)),r&&(c=c.filter(g=>g.filename.toLowerCase().includes(r))),i(c)};p.addEventListener("change",x),u.addEventListener("input",x)}function Le(t){const e=document.getElementById("preview-drawer"),n=document.getElementById("drawer-filename"),i=document.getElementById("drawer-folder"),o=document.getElementById("drawer-content"),a=document.getElementById("drawer-close");n.textContent=t.filename,i.textContent=t.folder,o.textContent=t.extracted_text||"[O texto extraído deste arquivo está em branco]",e.style.right="0",a.onclick=()=>e.style.right="-550px"}async function Oe(t){t.innerHTML=`
        <div class="page-title-section">
    ...
    `;const e=document.getElementById("btn-validate-coherence"),n=document.getElementById("coherence-loading"),i=document.getElementById("coherence-report-box");e.onclick=async()=>{e.style.display="none",n.style.display="block",i.style.display="none";try{const[o,a]=await Promise.all([k.restGet(`/projects?id=eq.${l.activeProjectId}`),k.restGet(`/modules?project_id=eq.${l.activeProjectId}&order=module_number`)]),s=o&&o.length>0?`BRIEFING DO PROJETO:
Nome: ${o[0].name}
Nicho: ${o[0].niche}
Promessa: ${o[0].promise}
Público: ${o[0].target_audience}`:"",p=a?a.filter(m=>m.generated_content&&m.module_number!==0).map(m=>({number:m.module_number,title:m.title,content:m.generated_content})):[];if(p.length===0)throw new Error("Gere conteúdo em ao menos um módulo (M1 a M9) antes de rodar o Orquestrador de Coerência!");const u=p[p.length-1],x=await k.coherenceCheck(s,u.number,u.title,u.content,p.slice(0,-1));l.coherenceReport=x,Me(i,x),i.style.display="block",b("Auditoria concluída com sucesso!","success")}catch(o){b(`Falha na validação: ${o.message}`,"error"),e.style.display="block"}finally{n.style.display="none"}}}function Me(t,e){var i,o,a,s,p,u,x,m;const n=e.score>=80?"var(--accent-green)":e.score>=50?"orange":"var(--accent-red)";t.innerHTML=`
        ...
        <div class="dashboard-layout-grid" style="margin-top: 30px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                <div class="panel-card">
                    ...
                    <p style="font-size: 12px; color: var(--text-secondary); margin-top: 6px;"><strong>Alinhado com Eco/Newport?</strong> ${(u=e.toneCheck)!=null&&u.aligned?'<span style="color: var(--accent-green); font-weight:700;">Sim</span>':'<span style="color: var(--accent-red); font-weight:700;">Não</span>'}</p>
                ...
                <div class="panel-card">
                    ...
                    <ul style="padding-left: 16px; color: var(--text-secondary); font-size: 13px; line-height: 1.6;">
                        ${(m=e.recommendations)==null?void 0:m.map(r=>`<li>${r}</li>`).join("")}
                    </ul>
                </div>
            </div>
        </div>
    `,lucide.createIcons()}async function _e(t,e){var h;const n=l.modules.find(y=>y.module_number===e);if(!n)return;let i="",o=!1;try{const y=await k.getModuleContent(l.activeProjectId,e);y&&(i=y.generated_content||"",o=y.is_outdated||!1)}catch(y){console.error(y)}t.innerHTML=`
        <div class="page-title-section">
        ...
        <div class="three-panel-workspace" style="display: grid; grid-template-columns: 280px 1fr 280px; gap: 24px; min-height: 500px; height: calc(100vh - 180px); overflow: hidden;">
            ...
            <div class="panel-card flex-col" style="height: 100%; overflow-y: auto; padding: 20px; font-size: 12px;">
                ...
                <ul style="padding-left: 16px; color: var(--text-secondary); line-height: 1.6; margin-bottom: 20px;">
                    ${n.key_concepts.map(y=>`<li>${y}</li>`).join("")}
                </ul>
    ...
    `;const a=document.getElementById("module-textarea"),s=document.getElementById("engine-provider"),p=document.getElementById("funnel-stage"),u=document.getElementById("custom-prompt");s.onchange=()=>{l.activeProvider=s.value,l.activeProvider==="groq"?l.activeModel="llama-3.3-70b-versatile":l.activeProvider==="gemini"?l.activeModel="gemini-2.5-flash":l.activeProvider==="openrouter"?l.activeModel="anthropic/claude-3.5-sonnet":l.activeProvider==="perplexity"&&(l.activeModel="sonar-reasoning")},document.getElementById("btn-save-module").onclick=async()=>{try{await k.saveModuleContent(l.activeProjectId,e,a.value,n.title),b("Rascunho do módulo salvo com sucesso!","success")}catch(y){b(`Falha ao salvar: ${y.message}`,"error")}},document.getElementById("btn-save-version").onclick=async()=>{try{const y=await k.getModuleContent(l.activeProjectId,e);if(!y)throw new Error("Salve o rascunho primeiro antes de criar uma versão!");await k.saveModuleVersion(y.id,a.value),b("Nova versão criada no histórico!","success")}catch(y){b(`Falha ao criar versão: ${y.message}`,"error")}};const x=document.getElementById("btn-search-market"),m=document.getElementById("perplexity-search-query"),r=document.getElementById("market-research-result");x.onclick=async()=>{const y=m.value.trim();if(!y){b("Escreva sua query de busca!","error");return}x.disabled=!0,r.style.display="block",r.innerHTML='<span style="color: var(--accent-cyan);">Pesquisando na internet brasileira com Perplexity API...</span>';try{const P=await k.localPerplexitySearch(y);r.textContent=P.result||"Nenhum resultado retornado."}catch(P){r.textContent=`Erro ao realizar pesquisa via Perplexity API: ${P.message}`}finally{x.disabled=!1}};const c=document.getElementById("btn-generate-ai"),g=document.getElementById("streaming-overlay");c.onclick=async()=>{c.disabled=!0,g.style.display="flex",a.value="",l.activeGenerationText="",await k.generateModuleStream(l.activeProjectId,e,u.value,l.activeProvider,l.activeModel,p.value,y=>{l.activeGenerationText+=y,a.value=l.activeGenerationText},async()=>{g.style.display="none",c.disabled=!1,b("Geração concluída!","success"),await k.saveModuleContent(l.activeProjectId,e,a.value,n.title)},y=>{g.style.display="none",c.disabled=!1,b(`Falha na geração: ${y.message}`,"error")})},lucide.createIcons()}function De(t){let e="",n="#07080f",i=30,o="",a=null;const s={brand:{id:"brand",text:"SISTEMA A.C.A.D.E.M.I.A.",x:80,y:80,fontSize:24,fontFamily:"Outfit",fill:"#22d3ee",align:"center",width:920,fontWeight:"800",fontStyle:"normal"},title:{id:"title",text:"A PÓS-GRADUAÇÃO NÃO PRECISA SER UM MARTÍRIO",x:80,y:400,fontSize:56,fontFamily:"Outfit",fill:"#ffffff",align:"center",width:920,fontWeight:"800",fontStyle:"normal"},subtitle:{id:"subtitle",text:"Descubra seu perfil de improdutividade em 3 minutos.",x:80,y:650,fontSize:32,fontFamily:"Inter",fill:"#94a3b8",align:"center",width:920,fontWeight:"500",fontStyle:"normal"},cta:{id:"cta",text:"Fazer Teste Gratuito",x:340,y:1100,fontSize:26,fontFamily:"Outfit",fill:"#0f172a",bgColor:"#ff6b00",align:"center",width:400,fontWeight:"700",fontStyle:"normal"}};t.innerHTML=`
        <div class="page-title-section">
    ...
    `;const p=document.getElementById("canvas-format"),u=document.getElementById("visual-canvas-mock"),x=document.getElementById("mock-image-overlay"),m=document.getElementById("canvas-bg-color"),r=document.getElementById("canvas-bg-color-hex"),c=document.getElementById("canvas-image-prompt"),g=document.getElementById("btn-generate-image-ia"),h=document.getElementById("canvas-stock-query"),y=document.getElementById("btn-search-stock"),P=document.getElementById("canvas-file-upload"),w=document.getElementById("canvas-image-opacity"),A=document.getElementById("opacity-value"),C=document.getElementById("btn-generate-caption"),z=document.getElementById("caption-container"),X=document.getElementById("canvas-caption-text"),ee=document.getElementById("btn-copy-caption"),O=document.getElementById("unsplash-modal"),te=document.getElementById("btn-close-unsplash-modal"),M=document.getElementById("unsplash-modal-query"),F=document.getElementById("btn-unsplash-modal-search"),N=document.getElementById("unsplash-modal-results"),H=document.getElementById("btn-download-png");function D(){const E=p.value==="story",I=(E?240:320)/1080;E?(u.style.width="240px",u.style.height="426px"):(u.style.width="320px",u.style.height="400px"),u.style.backgroundColor=n,r.value=n.toUpperCase(),m.value=n,e?(u.style.backgroundImage=`url("${e}")`,x.style.backgroundColor=`rgba(7, 8, 15, ${1-parseFloat(i)/100})`):(u.style.backgroundImage="none",x.style.backgroundColor="rgba(7, 8, 15, 0)"),Object.keys(s).forEach(T=>{const v=s[T],$=document.getElementById(`el-${T}`),q=document.getElementById(`preview-${T}-span`);$.style.left=v.x*I+"px",$.style.top=v.y*I+"px",$.style.width=v.width*I+"px",q.textContent=v.text,$.style.color=v.fill,$.style.fontSize=v.fontSize*I+"px",$.style.fontFamily=`${v.fontFamily}, sans-serif`,$.style.fontWeight=v.fontWeight,$.style.fontStyle=v.fontStyle,$.style.textAlign=v.align,T==="brand"&&(q.style.letterSpacing=2*I+"px"),T==="cta"?($.style.backgroundColor=v.bgColor||"#ff6b00",$.style.padding=`${6*I}px ${14*I}px`,$.style.color=v.fill||"#0f172a"):($.style.backgroundColor="transparent",$.style.padding="0"),a===T?($.style.border="1px dashed var(--accent-cyan)",$.style.boxShadow="0 0 8px rgba(34, 211, 238, 0.4)"):($.style.border="1px dashed transparent",$.style.boxShadow="none")})}p.onchange=D,m.oninput=()=>{n=m.value,D()},r.oninput=()=>{const f=r.value.trim();/^#[0-9A-F]{6}$/i.test(f)&&(n=f,D())},w.oninput=()=>{i=w.value,A.textContent=`${i}%`,D()},P.onchange=()=>{const f=P.files[0];if(f){const E=new FileReader;E.onload=d=>{e=d.target.result,D(),b("Imagem local carregada com sucesso!","success")},E.readAsDataURL(f)}};function K(f){a=f,D();const E=document.getElementById("style-panel-selection");if(!f){E.innerHTML=`
            ...
            `,lucide.createIcons();return}const d=s[f];E.innerHTML=`
            <div style="display: flex; flex-direction: column; gap: 14px;">
                <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
                    <span style="font-size: 11px; color: var(--accent-cyan); font-weight: 700; text-transform: uppercase;">Elemento: ${f.toUpperCase()}</span>
                ...
                <div class="form-group">
                    ...
                    ${f==="title"?`<textarea id="style-text" class="form-textarea" style="font-size: 11px; height: 50px; resize:none;">${d.text}</textarea>`:`<input type="text" id="style-text" class="form-input-text" value="${d.text}" style="font-size: 11px;">`}
                </div>
        ...
        `;const I=document.getElementById("style-text"),T=document.getElementById("style-font-family"),v=document.getElementById("style-font-size"),$=document.getElementById("style-font-size-num"),q=document.getElementById("style-align"),B=document.getElementById("btn-style-bold"),S=document.getElementById("btn-style-italic"),R=document.getElementById("style-fill"),j=document.getElementById("style-fill-hex"),Y=document.getElementById("style-pos-x"),U=document.getElementById("style-pos-y"),G=()=>{d.text=I.value,d.fontFamily=T.value,d.fontSize=parseInt(v.value),d.align=q.value,d.x=parseInt(Y.value)||0,d.y=parseInt(U.value)||0,D()};if(I.oninput=G,T.onchange=G,v.oninput=()=>{$.value=v.value,document.getElementById("style-font-size-val").textContent=`${v.value}px`,G()},$.oninput=()=>{v.value=$.value,document.getElementById("style-font-size-val").textContent=`${$.value}px`,G()},q.onchange=G,B.onclick=()=>{d.fontWeight==="800"||d.fontWeight==="700"?(d.fontWeight="normal",B.classList.remove("active")):(d.fontWeight=f==="brand"||f==="title"?"800":"700",B.classList.add("active")),D()},S.onclick=()=>{d.fontStyle==="italic"?(d.fontStyle="normal",S.classList.remove("active")):(d.fontStyle="italic",S.classList.add("active")),D()},R.oninput=()=>{d.fill=R.value,j.value=d.fill.toUpperCase(),D()},j.oninput=()=>{/^#[0-9A-F]{6}$/i.test(j.value)&&(d.fill=j.value,R.value=d.fill,D())},E.querySelectorAll(".preset-color-btn").forEach(W=>{W.onclick=()=>{const V=W.getAttribute("data-color");d.fill=V,R.value=V,j.value=V.toUpperCase(),D()}}),f==="cta"){const W=document.getElementById("style-cta-bg"),V=document.getElementById("style-cta-bg-hex");W.oninput=()=>{d.bgColor=W.value,V.value=d.bgColor.toUpperCase(),D()},V.oninput=()=>{/^#[0-9A-F]{6}$/i.test(V.value)&&(d.bgColor=V.value,W.value=d.bgColor,D())}}Y.oninput=G,U.oninput=G,document.getElementById("btn-close-style").onclick=()=>K(null),lucide.createIcons()}Object.keys(s).forEach(f=>{document.getElementById(`el-${f}`).addEventListener("click",d=>{d.stopPropagation(),K(f)})}),u.addEventListener("click",()=>{K(null)});let ne=!1,L=null,de=0,pe=0,ue=0,me=0;Object.keys(s).forEach(f=>{const E=document.getElementById(`el-${f}`);E.addEventListener("mousedown",d=>{d.button===0&&(ne=!0,L=f,de=d.clientX,pe=d.clientY,ue=s[f].x,me=s[f].y,K(f),E.style.cursor="grabbing",d.preventDefault())}),E.addEventListener("touchstart",d=>{const I=d.touches[0];ne=!0,L=f,de=I.clientX,pe=I.clientY,ue=s[f].x,me=s[f].y,K(f),E.style.cursor="grabbing"})}),document.addEventListener("mousemove",f=>{if(!ne||!L)return;const d=p.value==="story",T=(d?240:320)/1080,v=f.clientX-de,$=f.clientY-pe,q=v/T,B=$/T;s[L].x=ue+q,s[L].y=me+B,s[L].x<-150&&(s[L].x=-150),s[L].y<-150&&(s[L].y=-150);const S=d?1920:1350;if(s[L].x>1080&&(s[L].x=1080),s[L].y>S&&(s[L].y=S),D(),a===L){const R=document.getElementById("style-pos-x"),j=document.getElementById("style-pos-y");R&&j&&(R.value=Math.round(s[L].x),j.value=Math.round(s[L].y))}}),document.addEventListener("touchmove",f=>{if(!ne||!L)return;const E=f.touches[0],v=(p.value==="story"?240:320)/1080,$=E.clientX-de,q=E.clientY-pe,B=$/v,S=q/v;if(s[L].x=ue+B,s[L].y=me+S,D(),a===L){const R=document.getElementById("style-pos-x"),j=document.getElementById("style-pos-y");R&&j&&(R.value=Math.round(s[L].x),j.value=Math.round(s[L].y))}});const be=()=>{if(ne&&L){const f=document.getElementById(`el-${L}`);f&&(f.style.cursor="move")}ne=!1,L=null};document.addEventListener("mouseup",be),document.addEventListener("touchend",be),g.onclick=async()=>{const f=c.value.trim()||s.title.text;if(!f){b("Digite um prompt ou preencha o título para gerar o fundo!","warning");return}g.disabled=!0,g.innerHTML='<span class="loading-spinner" style="width:14px; height:14px; display:inline-block; border:2px solid rgba(255,255,255,0.3); border-radius:50%; border-top-color:white; animation:spin 1s ease-in-out infinite;"></span>',b("Gerando imagem com Imagen 3 de última geração...","info");try{const E=p.value==="story",d=1080,I=E?1920:1350,T=await k.generatePostImage(f,"dark premium, highly detailed, moody cinematic lighting, bokeh",d,I);if(T.imageUrl)e=T.imageUrl,D(),b("Plano de fundo gerado com sucesso!","success");else throw new Error(T.error||"Erro na geração de imagens.")}catch(E){b(`Falha ao gerar imagem: ${E.message}`,"error")}finally{g.disabled=!1,g.innerHTML='<i data-lucide="sparkles" style="width: 14px; height: 14px;"></i>',lucide.createIcons()}};async function ye(){const f=M.value.trim();if(!f){N.innerHTML='<div style="text-align:center; padding:40px; color:var(--text-muted);">Digite termos para busca.</div>';return}N.innerHTML='<div style="text-align:center; padding:40px; color:var(--text-secondary);"><span class="loading-spinner" style="width:24px; height:24px; display:inline-block; border:3px solid rgba(255,255,255,0.2); border-radius:50%; border-top-color:var(--accent-purple); animation:spin 1s ease-in-out infinite; margin-bottom:10px;"></span><br>Buscando imagens...</div>';try{const E=await k.searchStockImages(f,12,"portrait");E.images&&E.images.length>0?(N.innerHTML=`
                ...
                `,N.querySelectorAll(".unsplash-thumb").forEach(d=>{d.onclick=()=>{e=d.getAttribute("data-url"),O.style.display="none",D(),b("Imagem do Unsplash aplicada!","success")},d.onmouseenter=()=>d.style.transform="scale(1.03)",d.onmouseleave=()=>d.style.transform="scale(1.0)"})):N.innerHTML='<div style="text-align:center; padding:40px; color:var(--text-muted);">Nenhuma imagem encontrada para este termo.</div>'}catch(E){N.innerHTML=`<div style="text-align:center; padding:40px; color:var(--accent-red);">Erro na busca: ${E.message}</div>`}}y.onclick=()=>{O.style.display="flex",M.value=h.value.trim()||s.title.text.substring(0,20).trim(),ye()},F.onclick=ye,M.onkeydown=f=>{f.key==="Enter"&&ye()},te.onclick=()=>{O.style.display="none"},C.onclick=async()=>{C.disabled=!0,C.innerHTML='<span class="loading-spinner" style="width:12px; height:12px; display:inline-block; border:2px solid rgba(255,255,255,0.3); border-radius:50%; border-top-color:white; animation:spin 1s ease-in-out infinite; margin-right:6px;"></span> Gerando...';try{let f="",E="";l.activeProject&&(f=l.activeProject.niche||"",E=l.activeProject.target_audience||"");const d=await k.generatePostCaption(s.title.text,s.subtitle.text,"",f,E,"profissional e engajante","Instagram");if(d.caption)o=d.caption,X.value=o,z.style.display="flex",b("Legenda gerada com sucesso!","success");else throw new Error(d.error||"Nenhum texto de legenda foi retornado.")}catch(f){b(`Falha ao gerar legenda: ${f.message}`,"error")}finally{C.disabled=!1,C.innerHTML='<i data-lucide="sparkles" style="width: 12px; height: 12px; margin-right: 6px;"></i> Gerar Legenda',lucide.createIcons()}},ee.onclick=()=>{navigator.clipboard.writeText(X.value),b("Legenda copiada para a área de transferência!","success")},H.onclick=async()=>{b("Renderizando imagem de alta resolução...","info"),H.disabled=!0,H.innerHTML='<span class="loading-spinner" style="width:14px; height:14px; display:inline-block; border:2px solid rgba(255,255,255,0.3); border-radius:50%; border-top-color:white; animation:spin 1s ease-in-out infinite; margin-right:6px;"></span> Baixando...';try{const f=p.value,E=f==="story",d=1080,I=E?1920:1350,T=document.createElement("canvas");T.width=d,T.height=I;const v=T.getContext("2d");if(v.fillStyle=n||"#07080f",v.fillRect(0,0,d,I),e)try{const B=new Image;if(B.crossOrigin="anonymous",await new Promise(S=>{B.onload=S,B.onerror=()=>{console.warn("Could not load image cross-origin. Falling back to background color."),S()},B.src=e}),B.complete&&B.naturalWidth>0){const S=d/I,R=B.width/B.height;let j=d,Y=I,U=0,G=0;R>S?(j=I*R,U=(d-j)/2):(Y=d/R,G=(I-Y)/2),v.save(),v.globalAlpha=parseFloat(i)/100,v.drawImage(B,U,G,j,Y),v.restore()}}catch(B){console.error("Image draw error:",B)}const $=v.createLinearGradient(0,0,0,I);$.addColorStop(0,"rgba(7, 8, 15, 0.45)"),$.addColorStop(.5,"rgba(7, 8, 15, 0.65)"),$.addColorStop(1,"rgba(7, 8, 15, 0.85)"),v.fillStyle=$,v.fillRect(0,0,d,I),Object.keys(s).forEach(B=>{const S=s[B];v.save(),v.textAlign=S.align,v.textBaseline="top",v.fillStyle=S.fill;const R=`${S.fontStyle==="italic"?"italic":""} ${S.fontWeight==="800"||S.fontWeight==="700"?S.fontWeight:"500"}`;v.font=`${R} ${S.fontSize}px ${S.fontFamily}, sans-serif`;let j=S.x;if(S.align==="center"?j=S.x+S.width/2:S.align==="right"&&(j=S.x+S.width),B==="cta"){const U=v.measureText(S.text.toUpperCase()).width+80,G=64,W=j-U/2,V=S.y;v.fillStyle=S.bgColor||"#ff6b00",Pe(v,W,V,U,G,8,!0,!1),v.fillStyle=S.fill||"#0f172a",v.textAlign="center",v.textBaseline="middle",v.fillText(S.text.toUpperCase(),j,V+G/2)}else{const Y=Ae(v,B==="brand"||B==="title"?S.text.toUpperCase():S.text,S.width);let U=S.y;B==="brand"&&(v.letterSpacing="3px"),Y.forEach(G=>{v.fillText(G,j,U),U+=S.fontSize*1.25})}v.restore()});const q=document.createElement("a");q.download=`criativo_${f}_${Date.now()}.png`,q.href=T.toDataURL("image/png"),q.click(),b("Download concluído com sucesso!","success")}catch(f){b(`Erro na exportação local: ${f.message}`,"error")}finally{H.disabled=!1,H.innerHTML='<i data-lucide="download" style="width: 14px; height: 14px; margin-right: 6px;"></i> <span>Baixar PNG em Alta Resolução</span>',lucide.createIcons()}};function Ae(f,E,d){const I=E.split(" "),T=[];let v=I[0];for(let $=1;$<I.length;$++){const q=I[$];f.measureText(v+" "+q).width<d?v+=" "+q:(T.push(v),v=q)}return T.push(v),T}function Pe(f,E,d,I,T,v,$,q){if(typeof v=="number")v={tl:v,tr:v,br:v,bl:v};else{const B={tl:0,tr:0,br:0,bl:0};for(const S in B)v[S]=v[S]||B[S]}f.beginPath(),f.moveTo(E+v.tl,d),f.lineTo(E+I-v.tr,d),f.quadraticCurveTo(E+I,d,E+I,d+v.tr),f.lineTo(E+I,d+T-v.br),f.quadraticCurveTo(E+I,d+T,E+I-v.br,d+T),f.lineTo(E+v.bl,d+T),f.quadraticCurveTo(E,d+T,E,d+T-v.bl),f.lineTo(E,d+v.tl),f.quadraticCurveTo(E,d,E+v.tl,d),f.closePath(),f.fill()}(async()=>{try{if(l.activeProjectId){const f=await k.getModuleContent(l.activeProjectId,10);if(f&&f.generated_content){const E=f.generated_content.split(`
`);for(const d of E){const I=d.trim();/^Título\s*:/i.test(I)&&(s.title.text=I.replace(/^Título\s*:\s*/i,"").replace(/\*/g,"")),/^Subtítulo\s*:/i.test(I)&&(s.subtitle.text=I.replace(/^Subtítulo\s*:\s*/i,"").replace(/\*/g,"")),/^CTA\s*:/i.test(I)&&(s.cta.text=I.replace(/^CTA\s*:\s*/i,"").replace(/\*/g,"")),/^Prompt de Imagem\s*:/i.test(I)&&(c.value=I.replace(/^Prompt de Imagem\s*:\s*/i,"").replace(/\*/g,"")),/^Palavras-chave de Busca\s*:/i.test(I)&&(h.value=I.replace(/^Palavras-chave de Busca\s*:\s*/i,"").replace(/\*/g,""))}}}}catch(f){console.warn("Could not pre-populate from M10 content draft",f)}K(null),D()})(),lucide.createIcons()}function je(t){const e="https://kquyqumyjkjpeoyfeqit.supabase.co",n="sb_publishable_-bcadizrmBkwSoZL1_L1ug_ruzJ-Qk7";t.innerHTML=`
        <div class="page-title-section">
    ...
    `;const i=document.getElementById("tab-settings-cloud"),o=document.getElementById("tab-settings-local"),a=document.getElementById("tab-settings-drive"),s=document.getElementById("settings-tab-content"),p=r=>{[i,o,a].forEach(c=>c&&c.classList.remove("active")),r&&r.classList.add("active")},u=()=>{p(i),s.innerHTML=`
        ...
        `,document.getElementById("local-settings-form").onsubmit=async r=>{r.preventDefault();const c=document.getElementById("key-groq").value,g=document.getElementById("key-gemini").value,h=document.getElementById("key-openrouter").value,y=document.getElementById("key-perplexity").value,P=document.getElementById("key-unsplash").value,w=document.getElementById("local-workspace").value,A=document.getElementById("local-default-provider").value,C={groq_api_key:c,gemini_api_key:g,openrouter_api_key:h,perplexity_api_key:y,unsplash_access_key:P,workspace_path:w,default_provider:A};b("Salvando chaves locais no SQLite...","info");try{const z=await k.localUpdateSettings(C);l.localSettings=z,l.localActiveProvider=z.default_provider||"groq",b("Chaves e configurações locais salvas com sucesso!","success"),we()}catch(z){b(`Erro ao salvar chaves locais: ${z.message}`,"error")}},lucide.createIcons()},m=async()=>{p(a),s.innerHTML=`
        ...
        `,lucide.createIcons();try{const r=await k.driveStatus(),c=document.getElementById("drive-status-section"),g=[{ok:r.google_api_available,label:"API Google instalada"},{ok:r.credentials_configured,label:"Credenciais configuradas"},{ok:r.folder_configured,label:"Pasta configurada"},{ok:r.pdf_extraction_available,label:"Extração de PDF"}];c.innerHTML=g.map(h=>`
            ...
            `).join(""),r.last_sync&&(c.innerHTML+=`<div style="font-size:12px;color:var(--text-muted);width:100%;margin-top:4px;">Última sincronização: ${new Date(r.last_sync).toLocaleString("pt-BR")}</div>`),lucide.createIcons()}catch{document.getElementById("drive-status-section").innerHTML='<span style="color:var(--text-muted);font-size:12px;">⚠️ Backend local offline — status indisponível</span>'}document.getElementById("btn-drive-sync").onclick=async()=>{const r=document.getElementById("btn-drive-sync"),c=document.getElementById("drive-report");r.disabled=!0,r.innerHTML='<i data-lucide="loader-2" style="animation:spin 1s linear infinite;"></i><span>Sincronizando...</span>',lucide.createIcons();try{const g=await k.driveSyncWait(),h=g.synced||[],y=g.skipped||[],P=g.errors||[];c.style.display="block",c.innerHTML=`
                ...
                `,b(`Sincronização concluída! ${h.length} arquivo(s) atualizados.`,"success")}catch(g){b("Erro na sincronização: "+g.message,"error")}finally{r.disabled=!1,r.innerHTML='<i data-lucide="refresh-cw"></i><span>Sincronizar do Google Drive</span>',lucide.createIcons()}},document.getElementById("btn-drive-list").onclick=async()=>{const r=document.getElementById("drive-report");r.innerHTML='<div class="loading-spinner-container" style="min-height:60px;"><div class="spinner" style="width:16px;height:16px;border-width:2px;"></div></div>',r.style.display="block";try{const g=(await k.driveListFiles()).files||[],h={};g.forEach(y=>{const P=y.category||"geral";h[P]||(h[P]=[]),h[P].push(y)}),r.innerHTML=`
                    ...
                    `).join("")}
                `}catch(c){r.innerHTML=`<span style="color:var(--accent-red);font-size:13px;">Erro: ${c.message}</span>`}}};i.onclick=u,o.onclick=x,a.onclick=m,l.localHealth?x():u(),Ve()}function ie(t){return l.localHealth?!0:(t.innerHTML=`
            <div class="page-title-section">
    ...
    `;ce(t,"Agente: Instagram Copywriter","Converta temas complexos do livro A.C.A.D.E.M.I.A. em roteiros magnéticos de carrosséis e posts únicos para engajamento.",e,async n=>{const i=parseInt(document.getElementById("insta-module").value),o=document.getElementById("insta-post-type").value,a=document.getElementById("insta-custom").value,s=t.querySelector('input[name="funnel-stage"]:checked'),p=s?s.value:"TOPO";return await k.localGenerateInstagram(i,a,n,null,p,o)},"instagram")}function Fe(t){if(!ie(t))return;ce(t,"Agente: Blog SEO Copywriter","Gere artigos de blog de profunda validação científica, recheados de referências do livro e SEO otimizados.",`
        <div class="form-group">
        ...
        `,async n=>{const i=document.getElementById("blog-key").value,o=document.getElementById("blog-custom").value,a=t.querySelector('input[name="funnel-stage"]:checked'),s=a?a.value:"TOPO",p=t.querySelector('input[name="blog-format"]:checked'),u=p?p.value:"markdown";return await k.localGenerateBlog(i,o,n,null,s,u)},"blog_seo");const e=t.querySelectorAll(".format-option");e.forEach(n=>{n.addEventListener("click",()=>{e.forEach(o=>o.classList.remove("active")),n.classList.add("active");const i=n.querySelector('input[type="radio"]');i&&(i.checked=!0)})})}function Re(t){if(!ie(t))return;const e=`
        <div class="form-group">
    ...
    `;ce(t,"Agente: Novos Produtos & Bumps","Gere blueprints completos de novos microprodutos, templates de Notion e scripts de checkout rápidos.",e,async n=>{const i=parseInt(document.getElementById("prod-module").value),o=document.getElementById("prod-custom").value,a=t.querySelector('input[name="funnel-stage"]:checked'),s=a?a.value:"TOPO";return await k.localGenerateProduct(i,o,n,null,s)},"product")}function Ge(t){if(!ie(t))return;ce(t,"Agente: Criador de Temas","Gere pacotes estratégicos de temas, ideias de ganchos e hashtags alinhadas ao funil e aos perfis de improdutividade.",`
        <div class="form-group">
        ...
        `,async i=>{const o=document.getElementById("theme-funnel").value,a=document.getElementById("theme-icp").value,s=document.getElementById("theme-objective").value,p=document.getElementById("theme-qty").value,u=document.getElementById("theme-channel").value,x=document.getElementById("theme-source-type").value;let m=null;return x==="custom"&&(m=document.getElementById("theme-custom-subject").value),await k.localGenerateThemes(o,a,s,p,u,i,null,m)},"theme_creator");const e=document.getElementById("theme-source-type"),n=document.getElementById("theme-custom-subject-group");e&&n&&e.addEventListener("change",()=>{e.value==="custom"?n.style.display="block":n.style.display="none"})}function Ne(t){if(!ie(t))return;let e=l.localActiveCampaignPieces||{meta_ads:"",instagram:"",blog:""},n="meta_ads";t.innerHTML=`
        <div class="page-title-section">
    ...
    `;let i=l.localActiveProvider||"groq";const o=t.querySelectorAll(".engine-toggle-card");o.forEach(m=>{const r=m.getAttribute("data-provider");r===i&&(o.forEach(c=>c.classList.remove("active")),m.classList.add("active")),m.addEventListener("click",()=>{o.forEach(c=>c.classList.remove("active")),m.classList.add("active"),i=r,l.localActiveProvider=r,r==="groq"?l.localActiveModel="llama-3.3-70b-versatile":r==="gemini"?l.localActiveModel="gemini-2.5-flash":r==="openrouter"?l.localActiveModel="anthropic/claude-sonnet-4.5":r==="perplexity"&&(l.localActiveModel="sonar-reasoning-pro")})});const a=t.querySelectorAll(".campaign-tab-btn"),s=t.querySelector("#campaign-output-box"),p=()=>{const m=t.querySelector("#btn-csv-campaign");if(m&&(n==="instagram"&&!s.classList.contains("empty")&&e.instagram?m.style.display="inline-flex":m.style.display="none"),s.classList.contains("empty"))return;const r=e[n];if(!r)s.innerHTML='<div style="text-align: center; color: var(--text-muted); padding: 40px 0;">Nenhum conteúdo gerado para esta peça.</div>';else{const c=t.querySelector('input[name="campaign-format"]:checked'),g=c?c.value:"markdown";if(n==="blog"&&g==="html"){let h=r;h=h.replace(/```html\s*([\s\S]*?)\s*```/g,"$1"),h=h.replace(/```\s*([\s\S]*?)\s*```/g,"$1"),s.innerHTML=h}else s.innerHTML=re(r)}lucide.createIcons()};a.forEach(m=>{m.addEventListener("click",()=>{a.forEach(r=>r.classList.remove("active")),m.classList.add("active"),n=m.getAttribute("data-tab"),p()})});const u=t.querySelectorAll(".format-option");u.forEach(m=>{m.addEventListener("click",()=>{u.forEach(c=>c.classList.remove("active")),m.classList.add("active");const r=m.querySelector('input[type="radio"]');r&&(r.checked=!0),p()})}),t.querySelector("#btn-copy-campaign").addEventListener("click",()=>{const m=e[n];m&&!s.classList.contains("empty")?(navigator.clipboard.writeText(m),b("Peça copiada para a área de transferência!","success")):b("Nenhum conteúdo disponível para copiar nesta aba.","info")});const x=t.querySelector("#btn-csv-campaign");x&&x.addEventListener("click",()=>{const m=e.instagram;if(m&&!s.classList.contains("empty"))try{const r=ke(m);Se(r,`canva_lote_campanha_${l.localActiveGeneration.generation_id||Date.now()}.csv`),b("Planilha CSV da Campanha gerada para importação no Canva!","success")}catch(r){b(`Erro ao exportar CSV: ${r.message}`,"error")}else b("Nenhum conteúdo do Instagram gerado para exportar.","info")}),t.querySelector("#campaign-form").addEventListener("submit",async m=>{m.preventDefault();const r=t.querySelector("#btn-submit-campaign"),c=t.querySelector("#campaign-rating-container"),g=t.querySelector("#campaign-theme").value,h=t.querySelector("#campaign-insta-type").value,y=t.querySelector('input[name="campaign-format"]:checked'),P=y?y.value:"markdown";r.disabled=!0,r.innerHTML='<div class="spinner" style="width: 16px; height: 16px; border-width: 2px;"></div> <span>Orquestrando 360...</span>',s.className="output-text-area",s.innerHTML='<div class="loading-spinner-container"><div class="spinner"></div><p>Buscando na base de dados indexada (RAG)... e orquestrando as 3 peças promocionais. Aguarde cerca de 10 a 20 segundos.</p></div>',c.style.display="none",e={meta_ads:"",instagram:"",blog:""};try{const w=await k.localGenerateCampaign(g,i,null,P,h);l.localActiveGeneration=w;const A=w.output,C=M=>{const F=A.match(M);return F?{index:F.index,tag:F[0]}:{index:-1,tag:""}},z=C(/\[\[\[META_ADS\]\]\]/i),X=C(/\[\[\[INSTAGRAM\]\]\]/i),ee=C(/\[\[\[BLOG\]\]\]/i),O=(M,F)=>{if(M.index===-1)return"";const N=M.index+M.tag.length,H=F&&F.index!==-1?F.index:-1;return H===-1||H<M.index?A.substring(N).trim():A.substring(N,H).trim()},te=[{type:"meta_ads",match:z},{type:"instagram",match:X},{type:"blog",match:ee}].filter(M=>M.match.index!==-1).sort((M,F)=>M.match.index-F.match.index);e={meta_ads:"",instagram:"",blog:""};for(let M=0;M<te.length;M++){const F=te[M],N=M+1<te.length?te[M+1].match:null;e[F.type]=O(F.match,N)}l.localActiveCampaignPieces=e,s.className="output-text-area",p(),c.style.display="flex",Ie(w.generation_id,t),b("Campanha omnichannel gerada com sucesso!","success")}catch(w){s.className="output-text-area empty",s.innerHTML=`Falha na geração: ${w.message}`,b(`Erro na geração: ${w.message}`,"error")}finally{r.disabled=!1,r.innerHTML='<i data-lucide="layers"></i> <span>Disparar Orquestração 360°</span>',lucide.createIcons()}}),lucide.createIcons()}function Ie(t,e){const n=e.querySelectorAll("#campaign-rating-stars .star-icon");n.forEach(i=>{i.classList.remove("active"),i.addEventListener("click",async()=>{const o=parseInt(i.getAttribute("data-value"));n.forEach((a,s)=>{s<o?a.classList.add("active"):a.classList.remove("active")});try{await k.localRateGeneration(t,o),b("Obrigado pela sua avaliação!","success")}catch(a){b(`Falha ao salvar nota: ${a.message}`,"error")}})})}function ce(t,e,n,i,o,a){t.innerHTML=`
        <div class="page-title-section">
    ...
    `;let s=l.localActiveProvider||"groq";const p=t.querySelectorAll(".engine-toggle-card");p.forEach(r=>{const c=r.getAttribute("data-provider");c===s&&(p.forEach(g=>g.classList.remove("active")),r.classList.add("active")),r.addEventListener("click",()=>{p.forEach(g=>g.classList.remove("active")),r.classList.add("active"),s=c,l.localActiveProvider=c,c==="groq"?l.localActiveModel="llama-3.3-70b-versatile":c==="gemini"?l.localActiveModel="gemini-2.5-flash":c==="openrouter"?l.localActiveModel="anthropic/claude-sonnet-4.5":c==="perplexity"&&(l.localActiveModel="sonar-reasoning-pro")})});const u=t.querySelectorAll(".funnel-option");u.forEach(r=>{r.addEventListener("click",()=>{u.forEach(g=>g.classList.remove("active")),r.classList.add("active");const c=r.querySelector('input[type="radio"]');c&&(c.checked=!0)})}),document.getElementById("btn-copy-output").addEventListener("click",()=>{const r=document.getElementById("output-rendered-content");l.localActiveGeneration&&r&&!r.classList.contains("empty")?(navigator.clipboard.writeText(l.localActiveGeneration.output),b("Conteúdo copiado para a área de transferência!","success")):b("Nenhum conteúdo gerado para copiar.","info")});const x=document.getElementById("btn-adapt-output");x&&x.addEventListener("click",()=>{if(l.localActiveGeneration&&l.localActiveGeneration.output){const r=l.localActiveGeneration.type||a;He(l.localActiveGeneration.output,r)}else b("Nenhum conteúdo carregado para adaptar.","info")});const m=document.getElementById("btn-csv-output");m&&m.addEventListener("click",()=>{if(l.localActiveGeneration&&l.localActiveGeneration.output)try{const r=ke(l.localActiveGeneration.output);Se(r,`canva_lote_post_${l.localActiveGeneration.generation_id||Date.now()}.csv`),b("Planilha CSV gerada para importação no Canva!","success")}catch(r){b(`Erro ao exportar CSV: ${r.message}`,"error")}else b("Nenhum post gerado para exportar.","info")}),document.getElementById("agent-form").addEventListener("submit",async r=>{r.preventDefault();const c=document.getElementById("btn-submit-generate"),g=document.getElementById("output-rendered-content"),h=document.getElementById("rating-container");c.disabled=!0,c.innerHTML='<div class="spinner" style="width: 16px; height: 16px; border-width: 2px;"></div> <span>Processando Copiloto...</span>',g.className="output-text-area",g.innerHTML='<div class="loading-spinner-container"><div class="spinner"></div><p>Gerando conteúdo, orquestrando base teórica... Aguarde.</p></div>',h.style.display="none",x&&(x.style.display="none"),m&&(m.style.display="none");try{const y=await o(s);l.localActiveGeneration={...y,type:a};const P=t.querySelector('input[name="blog-format"]:checked');if((P?P.value:"markdown")==="html"){let A=y.output;const C=A.match(/(?:📝 CONTEÚDO COMPLETO DO ARTIGO:|📝 CONTEÚDO DO ARTIGO:)\s*([\s\S]*)/i);C&&(A=C[1].trim()),A=A.replace(/```html\s*([\s\S]*?)\s*```/g,"$1"),A=A.replace(/```\s*([\s\S]*?)\s*```/g,"$1"),g.innerHTML=A}else g.innerHTML=re(y.output);h.style.display="flex",x&&(x.style.display="inline-flex"),m&&(a==="instagram"||a==="campaign")&&(m.style.display="inline-flex"),fe(y.generation_id),b("Geração completada com sucesso!","success")}catch(y){g.className="output-text-area empty",g.innerHTML=`Falha na geração: ${y.message}`,b(`Erro na geração: ${y.message}`,"error")}finally{c.disabled=!1,c.innerHTML='<i data-lucide="sparkles"></i> <span>Gerar Conteúdo Inteligente</span>',lucide.createIcons()}}),lucide.createIcons()}function fe(t){const e=document.querySelectorAll("#rating-stars .star-icon");e.forEach(n=>{n.classList.remove("active"),n.addEventListener("click",async()=>{const i=parseInt(n.getAttribute("data-value"));e.forEach((o,a)=>{a<i?o.classList.add("active"):o.classList.remove("active")});try{await k.localRateGeneration(t,i),b("Obrigado pela sua avaliação!","success")}catch(o){b(`Falha ao salvar nota: ${o.message}`,"error")}})})}function He(t,e){const n=document.createElement("div");n.className="custom-modal-overlay active",n.id="adaptation-modal";let i="SEO Blog";e==="meta_ads"||e==="meta-ads"?i="Meta Ads":e==="instagram"?i="Instagram":e==="product"||e==="products"?i="Bumps / Produto":e==="theme_creator"||e==="theme-creator"?i="Criador de Temas":e==="campaign"&&(i="Campanha 360°"),n.innerHTML=`
...
<`),s=document.querySelector(`input[name="campaign-format"][value="${a?"html":"markdown"}"]`);s&&(s.checked=!0,document.querySelectorAll(".format-option").forEach(p=>{p.getAttribute("data-format")===(a?"html":"markdown")?p.classList.add("active"):p.classList.remove("active")}))}}}async function Ve(){const t=document.getElementById("history-items-list");if(t)try{const e=await k.localGetGenerations(30);if(e.length===0){t.innerHTML='<div style="text-align: center; color: var(--text-muted); padding: 40px 0; font-size: 13px;">Nenhuma geração registrada no histórico local ainda.</div>';return}t.innerHTML=e.map(n=>{const i=new Date(n.created_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"});let o=n.type;n.type==="meta_ads"?o="Meta Ads":n.type==="instagram"?o="Instagram":n.type==="blog_seo"?o="SEO Blog":n.type==="product"?o="Bumps / Produto":n.type==="campaign"?o="Campanha 360°":n.type==="theme_creator"&&(o="Criador de Temas");let a=Ue(n);return a||(a=o),`
            ...
            `}).join(""),t.querySelectorAll(".history-item").forEach(n=>{n.addEventListener("click",async()=>{const i=parseInt(n.getAttribute("data-id")),o=e.find(a=>a.id===i);if(o){let a="meta-ads";o.type==="instagram"?a="instagram":o.type==="blog_seo"?a="blog":o.type==="product"?a="products":o.type==="theme_creator"?a="theme-creator":o.type==="campaign"&&(a="campaign"),document.querySelectorAll(".nav-item").forEach(s=>{s.classList.remove("active"),s.getAttribute("data-page")===a&&s.classList.add("active")}),l.currentPage=a,oe(a),setTimeout(()=>{if(We(o),o.type==="campaign"){const s=document.getElementById("campaign-output-box"),p=document.getElementById("campaign-rating-container");if(s){s.className="output-text-area";const u=o.output_generated||o.output||"",x=w=>{const A=u.match(w);return A?{index:A.index,tag:A[0]}:{index:-1,tag:""}},m=x(/\[\[\[META_ADS\]\]\]/i),r=x(/\[\[\[INSTAGRAM\]\]\]/i),c=x(/\[\[\[BLOG\]\]\]/i),g=(w,A)=>{if(w.index===-1)return"";const C=w.index+w.tag.length,z=A&&A.index!==-1?A.index:-1;return z===-1||z<w.index?u.substring(C).trim():u.substring(C,z).trim()},h=[{type:"meta_ads",match:m},{type:"instagram",match:r},{type:"blog",match:c}].filter(w=>w.match.index!==-1).sort((w,A)=>w.match.index-A.match.index),y={meta_ads:"",instagram:"",blog:""};for(let w=0;w<h.length;w++){const A=h[w],C=w+1<h.length?h[w+1].match:null;y[A.type]=g(A.match,C)}!y.meta_ads&&!y.instagram&&!y.blog&&(y.meta_ads=u),l.localActiveCampaignPieces=y,l.localActiveGeneration={output:u,generation_id:o.id,type:o.type};const P=document.querySelector(".campaign-tab-btn.active");if(P)P.click();else{const w=document.querySelector(".campaign-tab-btn");w&&w.click()}p&&(p.style.display="flex",Ie(o.id,document.getElementById("page-content")),o.rating&&p.querySelectorAll(".star-icon").forEach((w,A)=>{A<o.rating?w.classList.add("active"):w.classList.remove("active")})),lucide.createIcons()}}else{const s=document.getElementById("output-rendered-content"),p=document.getElementById("rating-container");if(s){s.className="output-text-area";const u=o.output_generated||o.output||"";if(o.type==="blog_seo"&&(u.includes('<header class="site-header">')||u.includes('class="cta-block"')||u.includes("```html")||u.includes("<div")||u.includes("<p"))){let c=u;const g=c.match(/(?:📝 CONTEÚDO COMPLETO DO ARTIGO:|📝 CONTEÚDO DO ARTIGO:)\s*([\s\S]*)/i);g&&(c=g[1].trim()),c=c.replace(/```html\s*([\s\S]*?)\s*```/g,"$1"),c=c.replace(/```\s*([\s\S]*?)\s*```/g,"$1"),s.innerHTML=c}else s.innerHTML=re(u);l.localActiveGeneration={output:u,generation_id:o.id,type:o.type};const m=document.getElementById("btn-adapt-output");m&&(m.style.display="inline-flex");const r=document.getElementById("btn-csv-output");r&&(o.type==="instagram"?r.style.display="inline-flex":r.style.display="none"),p&&(p.style.display="flex",fe(o.id),o.rating&&p.querySelectorAll(".star-icon").forEach((c,g)=>{g<o.rating?c.classList.add("active"):c.classList.remove("active")})),lucide.createIcons()}}},50),b("Geração restaurada com sucesso!","info")}})})}catch{t.innerHTML='<div style="color: var(--accent-red); font-size: 12px; text-align: center; padding: 20px 0;">Erro ao carregar histórico.</div>'}}
